var nc = require('narcissus_packed');
...
function patch(code, functions, name) {
  var patches = [];
  for (var i=0; i<functions.length; i++) {
    ...
    var startCode;
    startCode = "var _trace"+l+"=_enterFunction(_trace"+sl+", this);try {"+setThis;
  ...
  patches.sort(function(a, b) {return (a.insertBefore+a.end*0.5)-(b.insertBefore+b.end*0.5);});
